...
public class Utils {
	...
	private static Color[] colors = { Color.BLUE, Color.CYAN, Color.GREEN, Color.MAGENTA, Color.RED, Color.YELLOW };
	...
	public static float calMultiLineStringWidth(String s, float fontSize, float scale) {
